...
async function generateFixtures() {
  console.log('🔧 Generating PTB test fixtures using REAL merchant keys...\n');
  ...
  console.log('   ✅ Valid payment PTB generated with REAL merchant signature');
  ...
  console.log(`✅ Fixtures saved to: ${outputPath}`);
...
(async () => {
  try {
    ...
    console.error('\n💡 Make sure facilitator is running: cd facilitator && npm run dev');
    process.exit(1);
  }
})();
